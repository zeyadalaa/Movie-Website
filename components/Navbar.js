    ...
    <div className={styles.navbar}>
        <div className="container">
            ...
            <div className={styles.navButton}>
              ...
              <li>
                <Link className={styles.link} href={"/tvseries"}>
                  Tv Series
                </Link>
              </li>
            </div>
